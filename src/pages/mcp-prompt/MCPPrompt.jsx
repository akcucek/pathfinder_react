      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          onError={(e) => { 
            ...
            e.target.parentElement.style.background = 'linear-gradient(to-br, #0f172a, #1e293b, #334155)';
          }}
        />
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900/85 via-blue-900/75 to-purple-900/90 backdrop-blur-[1px]"></div>
      </div>

      <div className="relative z-20">
        <Sidebar activeMenu={activeMenu} setActiveMenu={setActiveMenu} />
        
        <main className="pt-16 flex flex-col min-h-screen transition-all duration-300 ease-in-out bg-transparent">
          <div className="w-full px-4 md:px-8 py-4 md:py-6 lg:py-8">{}
            
            {/* Prompt Gallery Header Container */}
            <section className="w-full bg-slate-900/70 backdrop-blur-md border border-slate-600/50 rounded-xl p-6 mb-8 shadow-2xl hover:bg-slate-900/80 transition-all duration-300 flex flex-col items-start glass-card">
            ...
            <section className="w-full bg-slate-800/80 rounded-2xl shadow-2xl py-3 px-8 min-h-[48px] border border-slate-700/50 backdrop-blur-xl flex flex-col glass-card">
          ...
          <section className="w-full bg-slate-800/80 rounded-2xl shadow-2xl py-3 px-8 min-h-[48px] border border-slate-700/50 backdrop-blur-xl flex flex-col glass-card mt-6">
